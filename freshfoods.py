...
def display_results():
 ...
 #STUDENTS: Create the missing code to print out employee data, one line at a time
    for i in range(num_emps):
        ...
        data1 = emp[i] + "  " + job[i] + format(gross_pay[i], currency) + "   " + format(ded_rate_p1, currency) + "          " + format(ded_rate_p2, currency) + "     " + format(ded_rate_p3, currency) + "        " + format(ded_rate_p4, currency) + "      " + format(ded_rate_p5, currency)
        print(data1)
    print(line)
